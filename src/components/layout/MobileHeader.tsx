...
export const MobileHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 flex w-full select-none items-center justify-between border-b border-[rgba(2,1,8,0.08)] bg-white/78 px-4 py-3 text-right shadow-[0_10px_26px_rgba(2,1,8,0.05)] backdrop-blur-2xl lg:hidden">
      ...
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-2xl border border-[rgba(2,1,8,0.10)] bg-white/70 text-[#667085] transition-all hover:border-[#FF6B02]/24 hover:text-[#FF6B02]"
